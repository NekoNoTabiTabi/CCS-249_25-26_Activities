...
WIKI_URL = "https://en.wikipedia.org/wiki/Harry_Potter"
RANDOM_SEED = 42
...
def main():
    ...
    probe_words = [
        "harry", "potter", "hogwarts", "magic", "wizard",
        "book", "film", "series", "war", "battle"
    ]
    ...
    analogy_test = [
        ("book", "film", "series", "movie"),
        ("wizard", "magic", "war", "battle"),
        ("harry", "potter", "hogwarts", "school"),
        ("magic", "spell", "wizard", "witch"),
    ]
    ...
    words_to_visualize = [
        "harry", "potter", "hogwarts", "magic", "wizard", "book", "film", "series", "war", "battle",
        "handbook", "china", "express", "legacy", "deeper", "intends", "prizes", "industry", "development", "tomorrow"
    ]
    vectors = []
    valid_words = []
    ...
    if vectors:
        ...
        plt.title("PCA Visualization of Word2Vec Embeddings (Harry Potter Corpus)")
