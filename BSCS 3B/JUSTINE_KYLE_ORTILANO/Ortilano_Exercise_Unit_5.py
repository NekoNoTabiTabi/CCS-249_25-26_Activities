...
def main():
    ...
    probe_words = [
         "minecraft", "player", "survival", "crafting", "blocks",
         "creeper", "sandbox", "multiplayer", "mods", "notch"
    ]
    ...
    relatedness_test = [
        ...
        ("minecraft", "sandbox",    0.90),
        ("survival", "crafting",    0.85),
        ("blocks",   "world",       0.80),
        ("creeper",  "mob",         0.85),
        ("notch",    "mojang",      0.90),
        ("player",   "multiplayer", 0.80),
        ("mods",     "gameplay",    0.75),
        ("xbox",     "playstation", 0.80),
        ("minecraft", "tractor",    0.02),
        ("creeper",   "kitchen",    0.02),
        ("crafting",  "astronomy",  0.05),
        ("blocks",    "politics",   0.03),
    ...
    analogy_test = [
        ("survival", "crafting",    "player",     "character"),   # gameplay mechanics
        ("notch",    "mojang",      "persson",    "developer"),   # creator > company
        ("xbox",     "microsoft",   "playstation","sony"),        # platform > publisher
        ("creeper",  "mob",         "zombie",     "enemy"),       # monster types
    ]
    ...
    check_pairs = [
        ("minecraft", "sandbox"),    # core identity
        ("survival",  "crafting"),   # paired game modes
        ("creeper",   "mob"),        # enemy 
        ("minecraft", "airplane"),   # unrelated control pair
    ]
